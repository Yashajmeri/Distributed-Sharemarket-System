package org.example.replica.replica1;
...
public class ReplicaManager {
    ...
    private static final Config currentReplica = Config.REPLICA1;
    private static final String REPLICA_MANAGER_NAME = "ReplicaManager1";
    private static final String REPLICA_NAME = "REPLICA1";
    private static final String REPLICA_SHORT = "RM1";
...
//                    Message requestMessage = messageIterator.next();
    ...
    private static ShareMarket setStockMarketService(String userId) throws MalformedURLException, URISyntaxException {
        ...
        if (shareMarket != null) {
            ...
            QName qName = new QName("http://replica1.replica.example.org/", "StockMarketServiceImplService");
