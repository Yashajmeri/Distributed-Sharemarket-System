...
public class ReplicaManager {
    ...
    private static final Config currentReplica = Config.REPLICA4;
    private static final String REPLICA_MANAGER_NAME = "ReplicaManager4";
    private static final String REPLICA_NAME = "REPLICA4";
    private static final String REPLICA_SHORT = "RM4";
...
//                    Message requestMessage = messageIterator.next();
    ...
    private static ShareMarket setStockMarketService(String userId) throws MalformedURLException, URISyntaxException {
        ...
        if (shareMarket != null) {
            ...
            QName qName = new QName("http://replica4.replica.example.org/", "StockMarketServiceImplService");
