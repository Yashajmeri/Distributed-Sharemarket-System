...
public class ReplicaManager {
    ...
    private static final Config currentReplica = Config.REPLICA3;
    private static final String REPLICA_MANAGER_NAME = "ReplicaManager3";
    private static final String REPLICA_NAME = "REPLICA3";
    private static final String REPLICA_SHORT = "RM3";
...
//                    Message requestMessage = messageIterator.next();
    ...
    private static ShareMarket setStockMarketService(String userId) throws MalformedURLException, URISyntaxException {
        ...
        if (shareMarket != null) {
            ...
            QName qName = new QName("http://replica3.replica.example.org/", "StockMarketServiceImplService");
